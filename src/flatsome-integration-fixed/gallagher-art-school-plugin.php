<?php
/**
 * Plugin Name: Gallagher Art School Signup (Fixed)
 * Description: Beautiful multi-step signup form for art school with Supabase backend integration - Fixed for Flatsome compatibility
 * Version: 2.1.0
...
class GallagherArtSchoolPlugin {
    ...
    public function enqueue_assets() {
        if ($this->should_load_assets()) {
            // Main plugin CSS with higher priority to override theme styles
            wp_enqueue_style(
                'gallagher-styles',
            ...
            // Add inline CSS for additional Flatsome overrides
            $additional_css = '
            /* Additional Flatsome compatibility fixes */
            .gallagher-signup-container,
            .gallagher-signup-container *,
            .gallagher-signup-container *::before,
            .gallagher-signup-container *::after {
                box-sizing: border-box !important;
            }
            
            /* Prevent any parent container from affecting step indicators */
            .gallagher-step-indicator {
            ...
            ';
            wp_add_inline_style('gallagher-styles', $additional_css);
    ...
    public function signup_shortcode($atts) {
        ...
        <div class="gallagher-signup-container" data-background="<?php echo esc_url($atts['background_image']); ?>">
            ...
            <div class="gallagher-main-content">
                <!-- Left Panel - Enhanced Image Carousel (First in DOM = Top on Mobile) -->
                ...
                <!-- Right Panel - Signup Form (Second in DOM = Bottom on Mobile) -->
                <div class="gallagher-form-panel">
                    <div class="gallagher-signup-form">
                        <!-- Step Indicators - Fixed for Perfect Circles -->
                                ...
                                <div class="gallagher-form-group">
                                    ...
                                    <div class="gallagher-checkbox-grid">
                                        ...
                                        <div class="gallagher-checkbox-item">
                                            <input type="checkbox" id="interest-<?php echo strtolower(str_replace(' ', '-', $interest)); ?>" name="interests" value="<?php echo esc_attr($interest); ?>">
                                            <label for="interest-<?php echo strtolower(str_replace(' ', '-', $interest)); ?>"><?php echo esc_html($interest); ?></label>
                                        </div>
                                        <?php endforeach; ?>
                                    </div>
                                </div>
...
function gallagher_settings_page() {
    ...
    <div class="wrap">
        ...
        <p><strong>Desktop:</strong> Carousel on left, signup form on right</p>
        <p><strong>Mobile:</strong> Carousel on top, signup form below</p>
        <p><strong>Step Icons:</strong> Fixed to be perfect circles with Figma design colors (black/green/grey)</p>
        <p><strong>Select Dropdown:</strong> Light grey background with proper chevron positioning</p>
    </div>
    <?php
}
?>